...
hw_chaos.add_source_file("../src/Exponent_memory.vhdl")
hw_chaos.add_source_file("../src/deriv_calc_Vilnius.vhdl")
hw_chaos.add_source_file("../src/Vilnius_oscillator.vhdl")
