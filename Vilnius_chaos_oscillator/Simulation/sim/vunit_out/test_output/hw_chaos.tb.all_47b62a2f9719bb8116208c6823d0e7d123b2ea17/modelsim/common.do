...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini C:/Users/rusla/Desktop/ChaosVhdl/Vilnius_FPGA_update/Simulation_oscillator/sim/vunit_out/modelsim/modelsim.ini -wlf {C:/Users/rusla/Desktop/ChaosVhdl/Vilnius_FPGA_update/Simulation_oscillator/sim/vunit_out/test_output/hw_chaos.tb.all_47b62a2f9719bb8116208c6823d0e7d123b2ea17/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : C::/Users/rusla/Desktop/ChaosVhdl/Vilnius_FPGA_update/Simulation_oscillator/sim/vunit_out/test_output/hw_chaos.tb.all_47b62a2f9719bb8116208c6823d0e7d123b2ea17/,tb path : C::/Users/rusla/Desktop/ChaosVhdl/Vilnius_FPGA_update/Simulation_oscillator/tb/,use_color : false"} hw_chaos.tb(rtl)   -L vunit_lib -L osvvm -L hw_chaos}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini C:/Users/rusla/Desktop/ChaosVhdl/Vilnius_FPGA_update/Simulation_oscillator/sim/vunit_out/modelsim/modelsim.ini -wlf {C:/Users/rusla/Desktop/ChaosVhdl/Vilnius_FPGA_update/Simulation_oscillator/sim/vunit_out/test_output/hw_chaos.tb.all_47b62a2f9719bb8116208c6823d0e7d123b2ea17/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : C::/Users/rusla/Desktop/ChaosVhdl/Vilnius_FPGA_update/Simulation_oscillator/sim/vunit_out/test_output/hw_chaos.tb.all_47b62a2f9719bb8116208c6823d0e7d123b2ea17/,tb path : C::/Users/rusla/Desktop/ChaosVhdl/Vilnius_FPGA_update/Simulation_oscillator/tb/,use_color : false"} hw_chaos.tb(rtl)   -L vunit_lib -L osvvm -L hw_chaos' failed
...
proc is_test_suite_done {} {
    set fd [open "C:/Users/rusla/Desktop/ChaosVhdl/Vilnius_FPGA_update/Simulation_oscillator/sim/vunit_out/test_output/hw_chaos.tb.all_47b62a2f9719bb8116208c6823d0e7d123b2ea17/vunit_results" "r"]
...
proc vunit_compile {} {
    set cmd_show {C:\Users\rusla\AppData\Local\Programs\Python\Python312\python.exe -u run.py --compile -g}
    puts "Re-compiling using command ${cmd_show}"

    set chan [open |[list {C:\Users\rusla\AppData\Local\Programs\Python\Python312\python.exe} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['C:\\Users\\rusla\\AppData\\Local\\Programs\\Python\\Python312\\python.exe', '-u', 'run.py', '--compile', '-g'], cwd='C:\\Users\\rusla\\Desktop\\ChaosVhdl\\Vilnius_FPGA_update\\Simulation_oscillator\\sim', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
